...
export const routes: Routes = [
  ...
  { path: 'recommended', loadChildren: () => import('./features/recommended/recommended.routes').then(m => m.recommendedRoutes) },
  ...
  { path: 'cart', loadComponent: () => import('./features/orders/cart-page/cart-page.component').then(m => m.CartPageComponent) },
  { path: '**', redirectTo: '' },
];
